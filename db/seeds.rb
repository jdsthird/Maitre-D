...
Pairing.create!(guest: lesley, pair: fluffy)
Pairing.create!(guest: lesley, pair: furry)
Pairing.create!(guest: lesley, pair: fuzzy)
Pairing.create!(guest: lesley, pair: whiskers)
Pairing.create!(guest: lesley, pair: spot)
